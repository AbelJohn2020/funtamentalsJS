...
// getAperson(1, function(data) {
//     console.log(data);
//     getAperson(2, function(data) {
//         console.log(data);
//         getAperson(3, function(){
//             getAperson(4, function(data) {
//             console.log(data);
//                 getAperson(5, function(data) {
//                 console.log(data);
//                     getAperson(6, function(data) {
//                     console.log(data);
//                         getAperson(7, function(data) {
//                             console.log(data);})
//                     })
//                 })
//             })
